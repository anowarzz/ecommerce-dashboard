  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-around  bg-gray-800 py-10">
      <div className="mx-auto mb-4 md:mb-0 w-2/6 text-center">
        ...
        <div>
          ...
          <p className="text-white">
            Email: <span className="text-myYellow">admin@gmail.com</span>
          </p>
          <p className="text-white">
            Password: <span className="text-myYellow">admin123</span>
          </p>
        </div>
        ...
        <div className="mt-4">
          ...
          <p className="text-white">
            Email: <span className="text-myYellow">test@user.com</span>{" "}
          </p>
          <p className="text-white">
            Password: <span className="text-myYellow">Test123</span>
          </p>
        </div>
      </div>
        ...
        <div className="w-full max-w-md  mx-auto bg-white shadow-md dark:bg-gray-800">
          <div className="flex justify-around bg-purple-900 px-0 py-4">
            <NavLink
              ...
              className={({ isActive }) =>
                isActive
                  ? "font-medium text-xl md:text-2xl tracking-wide transition-colors duration-200 text-sky-400  ease-linear transform border-2 px-2 py-1 bg-gray-900 border-pink-600"
                  : "font-medium text-xl md:text-2xl tracking-wide text-white border-transparent  transition-colors duration-200 hover:text-sky-400 ease-linear transform border-4"
              }
            >
              Register
            </NavLink>
     ...
     dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40"
              ...
              {error && (
                <p className="text-red-500  text-sm font-bold text-center my-3">
                  {error}
                </p>
              )}
