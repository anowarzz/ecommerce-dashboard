...
const customer = {name, email, address: {city:address, zipcode: zipCode }, phone, addedOn}

console.log(customer);


// SENDING post request to the server to add a customer to the database
 axios.post('https://ecommerce-dashboard-server.vercel.app/customers', {customer})
 .then(response => {
...

{
    ...
    <h2 className="text-lg text-center font-semibold text-gray-700 capitalize dark:text-white mb-8">Add New Customer</h2>
