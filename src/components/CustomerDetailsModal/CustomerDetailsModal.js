...
<input type="checkbox" id="customerDetailsModal" className="modal-toggle" />
<div className="modal modal-bottom sm:modal-middle">
  <div className="modal-box">
    <h3 className="font-bold text-lg text-center mb-4 ">Customer Details</h3>

<ul>
<li className='text-blue-400'> Name: <span className='pl-4 text-yellow-500'>{name} </span> </li>
 <li className="text-blue-400"> Email: <span className='pl-4  text-yellow-500'>{email} </span> </li>
...
<li className="text-blue-400"> Added On: <span className='pl-4  text-yellow-500'>{addedOn}</span>  </li>
    ...
    <div className="modal-action">
      <label htmlFor="customerDetailsModal" className="btn btn-sm btn-danger">Back</label>
    </div>
  </div>
</div>
</div>
